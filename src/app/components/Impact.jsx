      ...
      >
        ...
        <div className="flex flex-col gap-6">
          <motion.h2
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="text-5xl md:text-5xl font-bold text-gray-900 dark:text-gray-100"
          >
            Pathlight Impact
          </motion.h2>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.7 }}
            className="text-lg dark:text-gray-300 max-w-xl"
          >
          ...
          >
            From urban centers to rural communities, Amira helps millions of
            students worldwide become proficient readers.
          </motion.p>
        </div>

        {/* RIGHT COLUMN — YOUR ORIGINAL STYLES PRESERVED */}
